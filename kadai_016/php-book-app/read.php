             ...
             <table class="books-table">
                 ...
                 foreach ($books as $book) {
                  $table_row = "
                      ...
                      <td><a href='update.php?id={$book['id']}'><img src='images/edit.png' alt='編集' class='sort-img'></a></td>
                      <td><a href='delete.php?id={$book['id']}'><img src='images/delete.png' alt='削除' class='sort-img'></a></td>
                      </tr>
                  ";
                  echo $table_row;
              }
